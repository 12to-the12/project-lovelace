...
class Menu(View):
    ...
    def draw(self):
        ...
        self.health_bar = BarView(x_pos = width, y_pos = 5, width = 100, height = 10, color = (55,255,55) )
        #bar_offset = width 
        self.sheild_bar = BarView( x_pos = (width - 100) - padding, y_pos= 5, width = 100, height = 10, color = (0,0,255))
        lcd_set_color(*(0,0,0))
...
class BarView(View):
    def __init__(self, name="", x_pos = 10, y_pos = 5, width = 100, height = 10, color=(255,255,255)):
        self.width = width
        self.height = height
        self.x = x_pos
        self.y = y_pos
    ...
    def draw(self):
        ...
        lcd_set_color(*self.color)
        lcd_draw_box((self.x - self.width) - 10, self.y, self.x - 10 , self.y + self.height)
